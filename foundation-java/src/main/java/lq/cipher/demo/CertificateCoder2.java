...
public abstract class CertificateCoder2 {
	...
	public static void main(String[] args) throws Exception {
		...
		String alias = "1";
		String certificatePath = "src/base/ca.cer";
		String keyStorePath = "src/base/ca.p12";
		...
		// 产生签名
		byte[] sign = CertificateCoder2.sign(data, keyStorePath, alias,
				password, certificatePath);
		System.err.println("签名:\n" + Hex.encodeHexString(sign));

		// 验证签名
		boolean status = CertificateCoder2.verify(data, sign, certificatePath);
